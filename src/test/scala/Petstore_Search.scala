...
class Petstore_Search extends Simulation {
	...
	val scn = scenario("petsearch").repeat(2) {
		...
		group("PetStore_S01_PetSearch_101_LaunchURL") {
			...
			.group("PetStore_S01_PetSearch_102_Login") {
			...
			.group("PetStore_S01_PetSearch_103_SearchGoldfish") {
			...
			// Logout //
			.group("PetStore_S01_PetSearch_106_Logout") {
